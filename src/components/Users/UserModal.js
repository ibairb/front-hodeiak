...
export const UserModal = ({ setOpen, setUser, user }) => {
    ...
    function addUser() {
        ...
        fetch(`http://localhost:8000/users/addUserProject/${user.email}/`, putTaskInPbi)
            ...
            >
                <div className="contenedorPrincipal" >
                    <div style={{
                        ...
                        {user.projects && user.projects.map(p => <div className='project'>
                            <h2>{p}</h2>
                            <Stack direction="row" spacing={1} display={"flex"}>
                                <Button style={{
                                    ...
                                    variant="outlined" startIcon={<CancelIcon />} onClick={(e) => setProjectDeleted(e.target.value)} >
